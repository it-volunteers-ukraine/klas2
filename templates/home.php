...
<main class="front-page__main">
  ...
  <section class="banner">
    ...
    <div id="mouse-parallax" class="mouse-parallax">
      <div id="mouse-parallax-bg" class="banner__back"
        style="background-image: url('<?php  echo get_field('banner_back'); ?>')">
      </div>
    </div>
      ...
      <div class="banner__cards">
        <div class="banner__cards-card">
          <div class="banner__cards-card-img">
            <p id="count" data-amount="<?php the_field('finished_projects_amount'); ?>" class="finished-proj__amount">0
            </p>
          </div>
          ...
          <div class="content__desc">
            <div class="content__desc-text">
              ...
              <div class="content__fon">
                <svg class="about__content-fon-svg" xmlns="http://www.w3.org/2000/svg" width="84" height="69"
                  viewBox="0 0 84 69" fill="none">
          ...
          <article class="new new--column  front-page__news-new">
            <div class="new__body">
              ...
              <div class="new__footer">
                ...
                <a href="<?php the_permalink(); ?>"
                  class="button read-more_button"><?php the_field('read-more_button', 'option'); ?><svg
                    class="arrow-icon">
          ...
          <div class="content__desc">
            <div class="content__desc-text">
              <div class="collaboration__content-fon content__fon">
                ...
                <svg class="collaboration__content-fon-svg" width="112" height="98" viewBox="0 0 112 98" fill="none"
    ...
    <div class="container">
      <div class="documents__wrap">
        ...
        <div class="documents__container">
          <div class="documents_text"><?php the_field('documents_text'); ?></div>

          <?php 
          $rows = get_field('documents_block');
          if( $rows ) { ?>
          <ul class="documents_block">
            <?php foreach( $rows as $row ) {
                  $image = $row['documents_image']; 
                  $document = $row['pdf']; ?>

            <li><a class="documents_item" href="<?php echo $document; ?>" download aria-label="Завантажити">

                <?php echo wp_get_attachment_image( $image, 'medium' );
                echo wp_kses_post( wpautop( $row['documents_descr'] ) );?>
        ...
        <div class="contacts__inner-list">
          ...
          <ul class="list__contact contacts__list">
            ...
            <li class="contacts__list-item">
              <a class="contacts__list-link" href="mailto:<?php the_field('email', 'options'); ?> " target="_blank">
            ...
            <li class="contacts__list-item">
              <a class="contacts__list-link"
                href="tel:<?php echo str_replace(' ', '', get_field('first-phone', 'options')); ?>" target="_blank">
            ...
            <li class="contacts__list-item">
              <a class="contacts__list-link"
                href="https://wa.me/<?php echo str_replace(' ', '', get_field('second-phone', 'options')); ?>"
                target="_blank">
            ...
            <li class="contacts__list-item">
              <a class="contacts__list-link" href="<?php echo esc_attr(get_field('facebook', 'options')); ?>"
                target="_blank">
            ...
            <li class="contacts__list-item">
              <a class="contacts__list-link" href="<?php echo esc_attr(get_field('youtube', 'options')); ?>"
                target="_blank">
